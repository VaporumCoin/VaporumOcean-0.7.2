 ...
 */
TEST(TestEvents, vaporum_faststateinit_test)
{
    SetupEnvironment();
    ...
    try
    {
        ...
        // pubkey record
        {
            ...
            char* dest = nullptr;
            // attempt to read the file
            int32_t result = vaporum_faststateinit( state, (char *)full_filename.string().c_str(), symbol, dest);
            // compare results
            EXPECT_EQ(result, 1);
            /* old way
            ...
            */
            ...
            std::shared_ptr<vaporum::event_pubkeys> ev2 = std::dynamic_pointer_cast<vaporum::event_pubkeys>(state->events.front());
        ...
        // notarized record
        {
            ...
            */
            ...
            std::shared_ptr<vaporum::event_notarized> ev2 = std::dynamic_pointer_cast<vaporum::event_notarized>( *(++state->events.begin()) );
            EXPECT_EQ(ev2->height, 1);
        ...
        // notarized M record
        {
            ...
            */
            ...
            std::advance(itr, 2);
            std::shared_ptr<vaporum::event_notarized> ev2 = std::dynamic_pointer_cast<vaporum::event_notarized>( *(itr) );
            EXPECT_EQ(ev2->height, 1);
            EXPECT_EQ(ev2->type, vaporum::vaporum_event_type::EVENT_NOTARIZED);
            // the serialized version should match the input
            EXPECT_TRUE(compare_serialization(full_filename.string(), ev2));
        ...
        // record type "U" (deprecated)
        {
            ...
            */
            ...
            std::shared_ptr<vaporum::event_u> ev2 = std::make_shared<vaporum::event_u>();
            ev2->height = 1;
            ev2->n = 'N';
            ev2->nid = 'I';
            memset(ev2->mask, 1, 8);
        ...
        // record type K (KMD height)
        {
            ...
            */
            ...
            auto itr = state->events.begin();
            std::advance(itr, 3);
            std::shared_ptr<vaporum::event_kmdheight> ev2 = std::dynamic_pointer_cast<vaporum::event_kmdheight>( *(itr) );
            EXPECT_EQ(ev2->height, 1);
        ...
        // record type R (opreturn)
        {
            ...
            */
            ...
            auto itr = state->events.begin();
            std::advance(itr, 5);
            std::shared_ptr<vaporum::event_opreturn> ev2 = std::dynamic_pointer_cast<vaporum::event_opreturn>( *(itr) );
            EXPECT_EQ(ev2->height, 1);
        ...
        // record type V
        {
            ...
            */
            ...
            auto itr = state->events.begin();
            std::advance(itr, 6);
            std::shared_ptr<vaporum::event_pricefeed> ev2 = std::dynamic_pointer_cast<vaporum::event_pricefeed>( *(itr) );
            EXPECT_EQ(ev2->height, 1);
        ...
        // record type B (rewind)
        {
            ...
            */
            ...
            auto itr = state->events.begin();
            std::advance(itr, 6);
            std::shared_ptr<vaporum::event_rewind> ev2 = std::dynamic_pointer_cast<vaporum::event_rewind>( *(itr) );
            EXPECT_NE(ev2, nullptr);
            EXPECT_EQ(ev2->height, 1);
            EXPECT_EQ(ev2->type, vaporum::vaporum_event_type::EVENT_REWIND);
            // the serialized version should match the input
            EXPECT_TRUE(compare_serialization(full_filename.string(), ev2));
            */
        }        
...
TEST(TestEvents, vaporum_faststateinit_test_kmd)
{
    SetupEnvironment();
