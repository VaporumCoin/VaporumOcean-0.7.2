...
void vaporum_stateind_set(struct vaporum_state *sp,uint32_t *inds,int32_t n,uint8_t *filedata,long datalen,char *symbol,char *dest)
{
 ...
 */
bool vaporum_faststateinit(vaporum_state *sp,const char *fname,char *symbol,char *dest)
{
